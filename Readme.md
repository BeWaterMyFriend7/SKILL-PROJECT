...
- 专业级别绘图相关skill：输出示例：svg-output
  ...
  - svg-generator[推荐] 生成高质量 SVG 图形，支持架构、流程、时序、关系、对比、时间线和总结图等
...
生成的图形 可以参考 相关skill 的示例目录或者svg-output目录
  ...
  - [svg-generator 使用说明与三种质感模式示例](docs/svg-generator/README.md)
...
- 编码相关skills[优化中]，输出示例目录：output
  ...
  - prototype-design-html 原型设计，产出简约、可交互的自包含 HTML
    - [使用说明与示例](docs/prototype-design-html/README.md)
  - prototype-design-xml 原型设计，产出可在 Draw.io 中编辑的简约页面原型
    - [使用说明与示例](docs/prototype-design-xml/README.md)
...
| skill-creator | 创建和管理 OpenCode Skills 的指南，帮助你设计并构建符合规范的技能清单 | https://github.com/anthropics/skills/tree/main/skills |
