...
### 按钮
```xml
<mxCell id="btn1" value="按钮文字" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#3498db;strokeColor=#3498db;strokeWidth=1;fontColor=#ffffff;fontSize=14;shadow=1;" vertex="1" parent="1">
