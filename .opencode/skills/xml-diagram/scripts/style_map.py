...
SEMANTIC_ROLE_KEYS = {
    "tech-blue": {"domain-app": "main-blue", "domain-control": "deep-blue", "domain-network": "data-cyan", "domain-data": "medium-blue"},
    "vibrant": {"domain-app": "blue", "domain-control": "purple", "domain-network": "cyan", "domain-data": "green", "status-success": "green", "status-warning": "orange", "status-error": "red"},
    "mint-green": {"domain-app": "mint-green", "domain-control": "teal-green", "domain-network": "teal-green", "domain-data": "mint-green"},
    "steady-red-blue": {"domain-app": "red", "domain-control": "navy", "domain-network": "accent-blue", "domain-data": "navy"},
}
SEMANTIC_ROLES = ("domain-app", "domain-control", "domain-network", "domain-data", "status-success", "status-warning", "status-error")
...
def _derive(base: str, mode: str, neutral: dict[str, str]) -> dict[str, str]:
    ...
    if mode == "light":
        return {
            ...
            "subtle": PALETTE.ensure_contrast(PALETTE.mix(base, "#FFFFFF", 0.94), neutral["canvas"], 1.06, "#000000"),
    ...
    return {
        ...
        "subtle": PALETTE.ensure_contrast(PALETTE.mix(base, neutral["surface"], 0.84), neutral["canvas"], 1.06, "#FFFFFF"),
        "border": PALETTE.ensure_contrast(
...
def build_style_map(
    ...
    **role_overrides: str | None,
    ...
    status_colors = {"status-success": palette["semantic"]["success"], "status-warning": palette["semantic"]["warning"], "status-error": palette["semantic"]["error"]}
