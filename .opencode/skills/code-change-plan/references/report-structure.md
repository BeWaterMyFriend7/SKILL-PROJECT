...
> 配合 SKILL.md 使用。定义最终 Markdown 方案文档必须包含的 7 个章节结构。
...
顺序原则：接口 / 常量定义先行 -> 业务实现 -> 配置 / 脚本 -> 测试 -> 文档。
...
12. Windows 环境下文件编辑统一使用 Python 临时脚本，显式指定 encoding：
    ...
    - Markdown 文档 -> 先读前 3 字节判断 BOM，写时保持一致
